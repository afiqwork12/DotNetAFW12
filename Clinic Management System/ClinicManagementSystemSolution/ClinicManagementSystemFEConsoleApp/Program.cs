...
namespace ClinicManagementSystemFEConsoleApp
{
    class Program
    {
        ...
        {
            appointments.Add(new Appointment() { Id = 1, PatientID = 101, DoctorID = 201, Details = "aaaa", Date = new DateTime(2022, 2, 16, 14, 00, 0), Price = -1, Status = "Opened" });
            appointments.Add(new Appointment() { Id = 2, PatientID = 101, DoctorID = 201, Details = "aaaa2", Date = new DateTime(2022, 1, 20, 12, 00, 0), Price = -1, Status = "Opened" });
            appointments.Add(new Appointment() { Id = 3, PatientID = 101, DoctorID = 201, Details = "aaaa3", Date = new DateTime(2022, 5, 20, 12, 00, 0), Price = -1, Status = "Opened" });
            appointments.Add(new Appointment() { Id = 4, PatientID = 101, DoctorID = 201, Details = "aaaa4", Date = new DateTime(2022, 1, 10, 14, 00, 0), Price = 444.36, Status = "Pending Payment" });
            appointments.Add(new Appointment() { Id = 5, PatientID = 101, DoctorID = 201, Details = "aaaa5", Date = new DateTime(2022, 1, 11, 14, 00, 0), Price = 52.2, Status = "Pending Payment" });
            appointments.Add(new Appointment() { Id = 6, PatientID = 101, DoctorID = 201, Details = "aaaa6", Date = new DateTime(2022, 1, 12, 14, 00, 0), Price = 62.2, Status = "Paid" });
            appointments.Add(new Appointment() { Id = 7, PatientID = 102, DoctorID = 201, Details = "bbbb", Date = new DateTime(2021, 12, 15, 11, 00, 0), Price = 20.0, Status = "Paid" });
            appointments.Add(new Appointment() { Id = 8, PatientID = 102, DoctorID = 201, Details = "cccc", Date = new DateTime(2020, 5, 4, 13, 00, 0), Price = 123.6, Status = "Paid" });
        }
